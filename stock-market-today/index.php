...
$blogdetail = mysqli_query($link, "SELECT * FROM blog where id='1523'");
...
<head>
    ...
    <meta property="og:image" content="https://www.finowings.com/admin/media/<?php echo $img; ?>" /><meta property="og:type" content="website" />
   ...
   <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top px-2">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="https://courses.finowings.com/" class="nav-item nav-link">Courses</a>
...
<!--Trading Blogs Start-->
        ...
        <div class="container py-2">
			<!--<div class="text-center">
                ...
                <p style="font-weight: 700; font-size:36px; font-family: Nunito,sans-serif; line-height: 1.2; color: #181d38;"><?php //echo $blogcat_name; ?></p>
			</div>	-->
...
<p style="font-size:12px; padding-top: 10px;"><a href="/">Home</a> >> <a href="https://www.finowings.com/blog/">Blog</a> >> <?php echo $title; ?></p>
...
<p align="center"><img src="https://www.finowings.com/admin/media/stock-maket-today-banner.webp" width="100%" /></p>
...
?>
<div>
<p style="font-size:18px !important; font-weight:bold;">Listen to this -</p>
...
?>
  ...
  <div class="faq-question">
    ...
    <div class="plus">+</div>
    <label for="q1" class="panel-title"><h5><?php echo $faq1; ?></h5></label>
...
?>
  ...
  <div class="faq-question">
    ...
    <div class="plus">+</div>
    <label for="q2" class="panel-title"><h5><?php echo $faq2; ?></h5></label>
...
?>  
  ...
  <div class="faq-question">
    ...
    <div class="plus">+</div>
    <label for="q3" class="panel-title"><h5><?php echo $faq3; ?></h5></label>
...
?>  
  ...
  <div class="faq-question">
    ...
    <div class="plus">+</div>
    <label for="q4" class="panel-title"><h5><?php echo $faq4; ?></h5></label>
...
?>  
  ...
  <div class="faq-question">
    ...
    <div class="plus">+</div>
    <label for="q5" class="panel-title"><h5><?php echo $faq5; ?></h5></label>
...
?>  
  ...
  <div class="faq-question">
    ...
    <div class="plus">+</div>
    <label for="q6" class="panel-title"><h5><?php echo $faq6; ?></h5></label>
...
?>  
  ...
  <div class="faq-question">
    ...
    <div class="plus">+</div>
    <label for="q7" class="panel-title"><h5><?php echo $faq7; ?></h5></label>
...
?>  
  ...
  <div class="faq-question">
    ...
    <div class="plus">+</div>
    <label for="q8" class="panel-title"><h5><?php echo $faq8; ?></h5></label>
...
?>  
  ...
  <div class="faq-question">
    ...
    <div class="plus">+</div>
    <label for="q9" class="panel-title"><h5><?php echo $faq9; ?></h5></label>
...
?>  
  ...
  <div class="faq-question">
    ...
    <div class="plus">+</div>
    <label for="q10" class="panel-title"><h5><?php echo $faq10; ?></h5></label>
...
<div class="col-lg-12">
<div class="text-center"><h5 class="section-title bg-white text-center text-primary px-3">Viewer's Thoughts</h5></div>
<br />  
	<?php showComments(); ?>
...
?>
<div class="row">
<div class="col-lg-4 col-md-5 col-sm-4 col-4"><img loading="lazy"  src="../admin/media/<?php echo $icon; ?>" alt="<?php if($img_alttag != '') { echo $img_alttag; } else { echo $imgname; }  ?>" class="img-fluid"></div>
...
<a href="../<?php echo $cat_name1; ?>/<?php echo $blog_url; ?>"><img loading="lazy"  src="../admin/media/<?php echo $pic; ?>" alt="<?php if($img_alttag != '') { echo $img_alttag; } else { echo $imgname; }  ?>" class="img-fluid mx-auto d-block"></a>
...
<a href="https://www.finowings.com/technical-analysis-course/"><img loading="lazy"  src="https://www.finowings.com/img/course-popup.webp" class="img-fluid mx-auto d-block" /></a>
