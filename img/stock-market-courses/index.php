      ...
      <div class="container">
        ...
        <div
          ...
          <div
            class="p-[10px] md:p-2 rounded-3xl bg-[#F5F5F5] border cust-shadow flex flex-col gap-2 justify-between course-card">
            <div class="flex flex-col justify-between gap-2 md:gap-[20px]">
              <img src="https://www.finowings.com/stock-market-courses/img/thumb/technical-live-class-100825.webp" alt="">
              <div class="text-20 leading-[1.16] font-bold text-[#2A3439]">
            ...
            <div class="mt-1 flex flex-col gap-2">
              <div class="text-20 leading-[1.75] md:leading-[1.16] font-extrabold text-[#2A3439]">
                <span class="price2"></span> <span class="line-through font-normal cutprice2"></span>
              </div>
      ...
      <div class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-[25px] mt-3 md:mt-6">
          <div
            ...
            <div class="mt-1 flex flex-col gap-2">
              <div class="text-20 leading-[1.75] md:leading-[1.16] font-extrabold text-[#2A3439]">
                <span class="price5"></span> <span class="line-through font-normal cutprice5"></span>
              </div>
          ...
          <div
            ...
            <div class="mt-1 flex flex-col gap-2">
              <div class="text-20 leading-[1.75] md:leading-[1.16] font-extrabold text-[#2A3439]">
                <span class="price6"></span> <span class="line-through font-normal cutprice6"></span>
              </div>
          ...
          <div
            ...
            <div class="mt-1 flex flex-col gap-2">
              <div class="text-20 leading-[1.75] md:leading-[1.16] font-extrabold text-[#2A3439]">
                <span class="price8"></span> <span class="line-through font-normal cutprice8"></span>
              </div>
