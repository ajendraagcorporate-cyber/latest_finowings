...
const price4 = document.querySelectorAll(".price4");
const cutprice4 = document.querySelectorAll(".cutprice4");
const banner4 = document.querySelectorAll(".banner4");
...
const getDocData = async () => {
  const { data, error } = await supabase
    ...
    .eq("course", "Complete-fundamental-technical-analysis");
  if (data) {
