...
const price5 = document.querySelectorAll(".price5");
const cutprice5 = document.querySelectorAll(".cutprice5");
const banner5 = document.querySelectorAll(".banner5");
...
const getDocData = async () => {
  const { data, error } = await supabase
    ...
    .eq("course", "Technical-analysis-and-fundament-analysis");
  if (data) {
