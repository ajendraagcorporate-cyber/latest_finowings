...
const pric2 = document.querySelectorAll(".price2");
const cutprice2 = document.querySelectorAll(".cutprice2");
const banner2 = document.querySelectorAll(".banner2");
...
const getDocData = async () => {
  const { data, error } = await supabase
    ...
    .eq("course", "Technical-analysis-course-recorded");
  if (data) {
