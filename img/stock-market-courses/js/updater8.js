...
const price8 = document.querySelectorAll(".price8");
const cutprice8 = document.querySelectorAll(".cutprice8");
const banner8 = document.querySelectorAll(".banner8");
...
const getDocData = async () => {
  const { data, error } = await supabase
    ...
    .eq("course", "Technical-analysis-fundamental-analysis-and-options-class");
  if (data) {
