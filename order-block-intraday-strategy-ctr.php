...
$link = $con;
//check for count
$query = "SELECT * FROM dematlinks_counter WHERE view_type='order-block-intraday-strategy'"; 
$result = mysqli_query($link, $query);
$rows = mysqli_fetch_array($result); 
$counter = $rows['totalview']; 
$counter = $counter + 1;
$t = "UPDATE dematlinks_counter SET totalview='".$counter."' WHERE view_type='order-block-intraday-strategy'"; 
