...
<head>
    ...
    <meta content="Stock Market is a place where investors buy and sell company's shares, This guide will cover basics of Stock Market." name="description">
	...
	<section id="fw-custom-section" class="courses-section">
		...
		?>
              <div class="fw-card wow fadeInUp" data-wow-delay="<?php echo $i; ?>s">
                ...
                <div class="fw-content" style="width:100%; cursor:pointer;" onclick="location.href='../basics-of-stock-market/<?php echo $blog_url; ?>';'">
                  <a href="../basics-of-stock-market/<?php echo $blog_url; ?>" class="fw-btn" aria-label="<?php echo $name; ?>">
                    Explore Now
                  </a>
                </div>
              </div>
