...
<head>
    <meta charset="utf-8">
    <title>Top Demat Account Frequently Asked Questions (FAQ) | Finowings</title>
  ...
  <div class="container-xxl py-5">
    <div class="container">
      ...
      <div class="text-center">
        <h6 class="section-title bg-white text-center text-primary px-3">Demat Account</h6>
        <h1 class="mb-3">Demat Account FAQs</h1><br />
