...
<head>
    ...
    <meta content="Investment Definition: Learn how investing in company shares can generate wealth. Understand the importance of long-term savings strategies." name="description">
                ...
                <div class="container">
                    ...
                    <div id="fw-unique-mobile-grid" class="fw-grid">
                        ...
                        while ($r = mysqli_fetch_array($chaptersF)) {
                            ...
                            // Skip hidden cards
                            if (in_array($blog_url, $hidden_cards)) {
                                continue;
                            }
                        ...
                        ?>
                            <div class="fw-card wow fadeInUp" data-wow-delay="<?php echo $i; ?>s">
                                ...
                                <div class="fw-content" style="width:100%; cursor:pointer;" onclick="location.href='../other-investment/<?php echo $blog_url; ?>';'">
                                    <a href="../other-investment/<?php echo $blog_url; ?>" target="_blank" class="fw-btn">
                                        <?php echo $name; ?>
                                    </a>
                                </div>
                            </div>
