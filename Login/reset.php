...
if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    $sql = "SELECT * FROM aspirants_mst WHERE login_email='$uname'";
    $result = mysqli_query($conn, $sql);

    if (mysqli_num_rows($result) > 0) {
		        $id = $result['id'];
 		        $sql1 = "update aspirants_mst set password='$password' where login_email='$uname'";				
...
<html lang="en">
<head>
	<title>Reset Password | Finowings Training Academy Pvt. Ltd.</title>
	<meta charset="UTF-8">
	   	...
	   	<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-120" method="post" action="">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Please enter your Contact Number">
						<input class="input100" type="password" name="password" placeholder="Please make new Password for Login">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="container-login100-form-btn p-t-20 p-b-23">
						...
						<input type="submit" name="submit" class="login100-form-btn" value="Reset">	
					</div>
