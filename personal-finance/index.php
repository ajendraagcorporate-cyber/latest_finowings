...
<head>
    ...
    <meta content="Personal Financial Planning: Discover how to optimize earnings, make money work for you, and achieve personal financial goals with proven strategies." name="description">
                    ...
                    <div id="fw-unique-mobile-grid" class="fw-grid">
                        ...
                        ?>
                            ...
                            <div class="fw-card wow fadeInUp" data-wow-delay="<?php echo $i; ?>s">
                                ...
                                <div class="fw-content" style="width:100%; cursor:pointer;" onclick="location.href='../personal-finance/<?php echo $blog_url; ?>';'">
                                    <a href="../personal-finance/<?php echo $blog_url; ?>" target="_blank" class="fw-btn">
                                        <?php echo $name; ?>
                                    </a>
                                </div>
                            </div>
