    ...
    <!-- Courses Section Start -->
     <div class="container-xxl py-5">
		...
		?>
                ...
                <div class="fw-content" style="width:100%; cursor:pointer;" onclick="location.href='../../../tax-planning-strategies/<?php echo $blog_url; ?>';'">
                  <a href="../../../tax-planning-strategies/<?php echo $blog_url; ?>" target="_blank" class="fw-btn">
                    <?php echo $name; ?>
                  </a>
                </div>
              </div>
