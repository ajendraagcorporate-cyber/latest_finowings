...
<!--Bootstrap code-->
	...
	<script src="js/sip-calc.js"></script>
     ...
     <div class="container-xxl py-5">
		...
		<div class="form-v4-content">
			<div class="form-left">
				...
				<p class="text-1" align="justify">Systematic Investment Plan (SIP) is an easy way to invest in Mutual Funds. Investors who cannot invest lump sum money, there is this facility that they can invest in mutual funds every month through SIP. SIP calculator is really a handy tool. With the help of this one can get an idea of the returns in his mutual fund investment through SIP. With this calculator you can calculate your Return on your SIP Investment</p>
				<!--<div class="form-left-last">
					<input type="submit" name="account" class="account" value="Have An Account">
				</div>-->
			</div>
			<form class="form-detail" method="post" id="myform">
				<h2 style="color:#436bb2;">SIP Calculator</h2>
				<div class="form-group">
					<div class="form-row form-row-1">
						<label for="first_name">Monthly Investment</label>
						<input type="text" name="investment_amount" id="investment_amount" class="input-text" placeholder="Ex: 100000" required>
					</div>
					<div class="form-row form-row-1">
						<label for="last_name">Tenure (in years)</label>
						<input type="text" name="loan_tenure" id="loan_tenure" class="input-text" placeholder="Ex: 10" required>
					</div>
				</div>
				<div class="form-row">
					<label for="your_email">Expected rate of Return (P.A)</label>
				...
				<div class="form-row-last">
					<input type="button" id="submitFormData" onclick="SubmitFormData();" value="Future Value" class="btn btn-primary" style="background:#00acea; color:#FFFFFF; text-decoration: none; border:1px solid #00acea;" /> 
				</div>
