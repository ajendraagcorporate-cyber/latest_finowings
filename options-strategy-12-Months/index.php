...
<h3 style="color: #406ab2;">Options Strategy - 12 Months</h3>
...
<font style="padding-top:22   px; font-size:24px; color: #406ab2;">&#x20B9; 28500</font>&nbsp;&nbsp;<font style="padding-top:20px; font-size:18px; color: red;"><del>&#x20B9; 32000</del></font>&nbsp;&nbsp;<font style="font-size: 14px;">&nbsp;(including 18% GST)</font>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
		  ...
		  <div class="row">
		  <input type="hidden" name="tid" id="tid" readonly />&nbsp;&nbsp;<input type="hidden" name="merchant_id" value="272337" />&nbsp;&nbsp;<input type="hidden" name="order_id" value="<?php echo mt_rand(10000000, 99999999) ?>"/>&nbsp;&nbsp;<input type="hidden" name="amount" value="28500" />&nbsp;&nbsp;<input type="hidden" name="currency" value="INR"/>&nbsp;&nbsp;<input type="hidden" name="redirect_url" value="https://www.finowings.com/options-strategy-12-Months/ccavResponseHandler.php"/>&nbsp;&nbsp;<input type="hidden" name="cancel_url" value="https://www.finowings.com/options-strategy-12-Months/ccavResponseHandler.php"/>&nbsp;&nbsp;<input type="hidden" name="language" value="EN"/>
		  </div>
