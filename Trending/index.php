...
<head>
    <meta charset="utf-8">
    <title>Blogs on the best Finance case studies online</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Best Finance Case Studies" name="keywords">
    <meta content="Finance case studies blogs|Read about the best financial management case studies such as Blinkit, Physics wallah success story, etc." name="description">
...
<p style="font-size:14px;"><a href="../Trending/" style="text-decoration: none; color: #406ab2;"><?php echo $cat_name; ?></a> | <?php echo $day; ?>-<?php echo $month; ?>- <?php echo $year; ?></p>
<?php
if ($count < 31)
{
?>
