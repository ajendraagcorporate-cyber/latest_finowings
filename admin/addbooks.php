...
$alt_tags = mysqli_real_escape_string($link, $_REQUEST['alt_tags']);
$book_link = mysqli_real_escape_string($link, $_REQUEST['book_link']);
$created_date = date("Y-m-d h:m:s");
$username = $_SESSION['user']['username'];

  
// Attempt insert query execution
$sql = "INSERT INTO books (book_name, book_image, alt_tags, book_link, created_date, update_user) VALUES ('$book_name', '$file', '$alt_tags', '$book_link', '$created_date', '$username')";
