...
.ellipsis {
  ...
  <div class="content-wrapper">
    ...
    <div align="center">
        <a class="btn btn-success" style="background: #273158; color: #FFFFFF; font-weight:bold;">Quiz User List</a>
    </div>
</div>  
<br>
<br> 
...
$query = "SELECT * FROM chapter_quiz_users order by id desc";
...
echo '<table border="1" cellspacing="2" cellpadding="2" style="width: 60%;" bgcolor="#FFFFFF" align="center"> 
      <tr class="tr"> 
         ...
         <td class="td"> <font face="Arial" color="#fffff">Quiz Date</font> </td> 
		   </tr>';
