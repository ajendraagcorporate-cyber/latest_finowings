...
.button {
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <div align="center">
        <a class="btn btn-success" style="background: #cf9c0a; color: #FFFFFF; font-weight:bold;">Add New Media</a> 
    </div>
...
<p>&nbsp;</p><p>&nbsp;</p>	
   <p align="left"><font color="#000000"><b> Upload Image : </b></font>&nbsp;&nbsp;&nbsp;
	...
	<p align="left"><font color="#000000"><b>Image alt Tag :</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input  type="text" style="width: 700px;" name="img_alttag"> </input></p><br><br>		
		...
		<p><input type="submit" name="submit" value="Add Media" style="background:#273158; height:40px; width:150px; color:#FFFFFF; font-weight:bold; font-size:16px;"></button>
