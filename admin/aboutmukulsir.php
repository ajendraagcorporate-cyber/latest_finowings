...
.ellipsis {
  ...
  <div class="content-wrapper" style="background: #FFFFFF;">
    ...
    <div align="center">
        <a class="btn btn-success" style="background: #273158; color: #FFFFFF; font-weight:bold;">About Mukul Sir</a>
    </div>
</div>  
<br>
<br> 
...
$query = "SELECT * FROM aboutmukulsir";
...
if ($result = mysqli_query($link, $query)) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr> 
                  ...
                  <td><a href="edit-mukulsir.php?i='.$field1name.'">Edit</td>
				  </tr>';
    }
    $result->free();
} 
