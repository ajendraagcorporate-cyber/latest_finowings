...
.ellipsis {
  ...
  <div class="content-wrapper">
    ...
    <div align="center">
        <a href="add-testimonial.php" class="btn btn-success"><i class="fa fa-download"></i>Add New Testimonial</a>
    </div>
</div>  
<br>
<br> 
...
if ($result = mysqli_query($link, $query)) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr> 
				  ...
				  <td><a href="delete-testimonial.php?i='.$field1name.'">Delete</td>
              </tr>';
    }
    $result->free();
} 
