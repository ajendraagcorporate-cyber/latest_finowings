...
.button {
  ...
  <div class="content-wrapper">
    ...
    <div class="float-left">
        <a href="export_data.php" class="btn btn-success"><i class="fa fa-download"></i> Export Excel File</a>
...
echo '<table border="0" cellspacing="2" cellpadding="2" style="width: 100%;"> 
      <tr class="tr"> 
          ...
          <td class="td"> <font face="Arial">Query</font> </td> 
          <td class="td"> <font face="Arial">Name</font> </td> 
          <td class="td"> <font face="Arial">Mobile</font> </td> 
          <td class="td"> <font face="Arial">City</font> </td> 
      </tr>';

if ($result = $mysqli->query($query)) {
    while ($row = $result->fetch_assoc()) {
        $field1name = $row["id"];
        $field2name = $row["selectc"];
        $field3name = $row["namec"];
