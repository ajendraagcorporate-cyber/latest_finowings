...
.ellipsis {
  ...
  <div class="content-wrapper">
    ...
    <div align="center">
        <a href="add-ipo-ques.php" class="btn btn-success"><i class="fa fa-download"></i> Add New IPO Question</a>
    </div>
</div>  
<br>
<br> 
	...
	<?php 
$query = "SELECT * FROM ipo_questions order by id desc";
...
if ($result = mysqli_query($link, $query)) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr> 
				  ...
				  if($_SESSION['user']['username'] == 'finoadmin')
				  {	  
				  echo '<td><a href="delete-ipoquestion.php?i='.$id.'">Delete</td>';
				  }
            echo '</tr>';
