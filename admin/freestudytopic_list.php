...
.ellipsis {
  ...
  <div class="content-wrapper">
    ...
    <div align="center">
        <a href="add-freestudy-topic.php" class="btn btn-success"><i class="fa fa-download"></i> Add New Topic</a>
    </div>
</div>  
<br>
<br> 
...
$query = "SELECT * FROM freestudytopic";
...
echo '<table border="1" cellspacing="2" cellpadding="2" style="width: 50%;" bgcolor="#FFFFFF" align="center"> 
      <tr class="tr"> 
          ...
          <td class="td"> <font face="Arial">Topic</font> </td>
...
if ($result = mysqli_query($link, $query)) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr> 
				  ...
				  <td><a href="edit-freestudytopic.php?i='.$field1name.'">Edit</td>
				  <td><a href="delete-freestudytopic.php?i='.$field1name.'">Delete</td>
              </tr>';
    }
    $result->free();
} 
