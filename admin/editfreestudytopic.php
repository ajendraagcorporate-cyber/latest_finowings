...
{	
$sql = "UPDATE freestudytopic SET topic='$topic', icon='$icon' where id='$id'";
}
else
{
$sql = "UPDATE freestudytopic SET topic='$topic' where id='$id'";	
}	
if(mysqli_query($link, $sql)){
  header( "Location: freestudytopic_list.php" );
} else{
...
.button {
  ...
  <div class="content-wrapper">
	...
	<br /><br />
<div align="center">
<h2 align="center">Your Record is Updated. <a href="freestudytopic_list.php">Click Here</a> for Topic Listing Page</h2> 
</div>
