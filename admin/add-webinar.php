...
.button {
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <div align="center">
        <a class="btn btn-success"><i class="fa fa-download"></i> Add Webinar</a> 
    </div>
	
	<br>
	<div align="center">
	<section class="content" style="border: 1px solid white; padding-left:30px; width: 50%; background:#FFFFFF;">
      <form method="post" action="addwebinar.php" enctype="multipart/form-data">
        <!-- Info boxes -->
		<p>&nbsp;</p>
        <p align="left"><font color="#000000"><b>Title :</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input  type="text" style="width: 500px;" name="title" required > </input></p> <br> <br>
		<p align="left"><font color="#000000"><b>Tag Line :</b></font>&nbsp;&nbsp;&nbsp;&nbsp;<input  type="text" style="width: 500px;" name="tagline" required > </input></p> <br> <br>
		 
  <p align="left"> <font color="#000000"><b>Description :</b></font> 
  <textarea  style="width: 400px; height:100px;" name="desc" id="desc" required> </textarea></p>
  ...
  <br><br>
   <p align="left"><font color="#000000"><b> Upload Image/Video : </b></font>
	<input  type="file" style="width: 500px;" name="fileToUpload" required> </input></p>	
		...
		<p><input type="submit" name="submit" value="Add Webinar" style="background: #999999;"></button>
