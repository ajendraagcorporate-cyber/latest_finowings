...
$company = mysqli_real_escape_string($link, $_REQUEST['company_name']);
$open = mysqli_real_escape_string($link, $_REQUEST['open']);
$close = mysqli_real_escape_string($link, $_REQUEST['close']);
$status = mysqli_real_escape_string($link, $_REQUEST['status']);
$username = $_SESSION['user']['username'];

  
// Attempt insert query execution
$sql = "INSERT INTO blogs_static (cat_id, company, open, close, status, username) VALUES ('$cat_id', '$company', '$open', '$close', '$status', '$username')";
if(mysqli_query($link, $sql)){
  header( "Location: staticblog_list.php" );
} else{
