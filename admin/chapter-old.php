...
<main>
<h2 align="center" style="font-size:36px; font-weight:700; padding-left:20px;"><?php echo $chapter_name; ?></h2>
<div class="blog-content" style="padding-left:20px;">
  <?php echo $cont; ?>
</div>
...
?>
<div class="row">
<div class="col-lg-4 col-md-5 col-sm-4 col-4"><img src="admin/media/courseicons/<?php echo $img; ?>" class="img-fluid"></div>
