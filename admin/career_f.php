...
$job_t = mysqli_real_escape_string($link, $_REQUEST['job_t']);
$job_d = mysqli_real_escape_string($link, $_REQUEST['job_d']);
$img = mysqli_real_escape_string($link, $_REQUEST['img']);

  
// Attempt insert query execution
$sql = "INSERT INTO career (job_t, job_d, img) VALUES ('$job_t', '$job_d', '$img')";
