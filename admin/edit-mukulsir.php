...
include('config.php');
$id = $_REQUEST['i'];
$query = "SELECT * FROM aboutmukulsir where id='$id'";
...
.button {
  ...
  <div class="content-wrapper" style="background: #FFFFFF;">
    ...
    <!-- Main content -->
    <div align="center">
        <a class="btn btn-success" style="background: #cf9c0a; color: #FFFFFF; font-weight:bold;">About Mukul Sir</a> 
    </div>
	
	<br>
	<div align="center">
	<section class="content" style="border: 1px solid #99999; padding-left:60px; width: 90%; background:#FFFFFF;">
      <form method="post" action="editmukulsir.php" enctype="multipart/form-data">
        <!-- Info boxes -->
		<p>&nbsp;</p>
