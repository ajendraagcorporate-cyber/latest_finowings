...
.ellipsis {
  ...
  <div class="content-wrapper">
    ...
    <div align="center">
        <a class="btn btn-success"><i class="fa fa-download"></i> Free Study Material Intro</a>
    </div>
</div>  
<br>
<br> 
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr> 
                  ...
                  <td><font color="black">'.$field2name.'</font></td>
					<td><a href="edit-freecourse-intro.php?i='.$field1name.'">Edit</td>
				  </tr>';
    }
    $result->free();
} 
