...
.button {
  ...
  <div class="content-wrapper">
    ...
    <div class="float-left">
        <a href="payment_data.php" class="btn btn-success"><i class="fa fa-download"></i> Export Excel File</a>
    </div>
	<div>
...
echo '<table border="0" cellspacing="2" cellpadding="2" style="width: 100%;"> 
      <tr class="tr"> 
          ...
          <td class="td"> <font face="Arial">Course Name</font> </td> 
          <td class="td"> <font face="Arial">amount</font> </td> 
      </tr>
	  '	  ; 
