...
$i = $_REQUEST['k'];
$sql = "UPDATE freestudychapter SET content='$content1' where id='$i'";
...
<html>
<head>
<title>Admin | Finowings Training Academy Pvt. Ltd.</title>
...
<body>
  ...
  <p align="center"><input type="hidden" name="k" value="<?php echo $id; ?>"></p>
