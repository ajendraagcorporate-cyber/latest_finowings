...
.ellipsis {
  ...
  <div class="content-wrapper">
    ...
    <div align="center">
        <a class="btn btn-success" style="background: #273158; color: #FFFFFF; font-weight:bold;">Course Leads</a>
    </div>
</div>  
<br>
<br> 
...
$query = "SELECT * FROM techanalysiscourse_leads order by id desc";
