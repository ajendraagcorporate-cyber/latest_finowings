...
.ellipsis {
  ...
  <div class="content-wrapper">
    ...
    <div align="center">
        <a class="btn btn-success" style="background: #273158; color: #FFFFFF; font-weight:bold;">Hindi Website Class CTR Enquiry List</a>
    </div>
</div>  
<br>
<br> 
...
$query = "SELECT * FROM hindi_tcenq order by id desc";
