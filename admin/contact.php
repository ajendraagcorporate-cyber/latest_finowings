...
.h2 {
  ...
  <div class="content-wrapper">
	...
	<section class="content" style="border: 2px solid white;padding-bottom: 68px; width: 1090px;">
      <form action="contact_f.php">
        <!-- Info boxes -->
		 <h2 class="h2"> Address </h2>
		<input  type="text" size="64" name="address" required> </input> <br> <br>
        <h2 class="h2"> Mobile No </h2>
		<input  size="64" name="mobile" required> </input> <br> <br>
		 <h2 class="h2"> Email </h2>
		<input  type="email" size="64" name="email" required> </input> <br><br> <br>
