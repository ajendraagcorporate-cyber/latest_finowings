...
.ellipsis {
  ...
  <div class="content-wrapper">
    ...
    <div align="center">
        <a class="btn btn-success" style="background: #273158; color: #FFFFFF; font-weight:bold;">Finowings Academy Aspirants</a>
    </div>
</div>  
<br>
<br> 
...
$query = "SELECT * FROM aspirants_mst order by id desc";

echo '<table border="1" cellspacing="2" cellpadding="2" style="width: 80%;" bgcolor="#FFFFFF" align="center"> 
      <tr class="tr"> 
          <td class="td"> <font face="Arial" color="#FFFFF">Sr No.</font> </td> 
          <td class="td"> <font face="Arial" color="#FFFFF">Name</font> </td> 
         <td class="td"> <font face="Arial" color="#FFFFF">Mobile</font> </td>
