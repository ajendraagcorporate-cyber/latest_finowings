...
{	
$sql = "UPDATE webinar SET title='$title', tagline='$tagline', descr='$desc', image1='$file', updated_date='$updated_date' where id='$id'";
}
else
{
$sql = "UPDATE webinar SET title='$title', tagline='$tagline', descr='$desc', updated_date='$updated_date' where id='$id'";	
}	
...
.button {
  ...
  <div class="content-wrapper">
	...
	<br /><br />
<div align="center">
<h2 align="center">Your Record is Updated. <a href="webinar_list.php">Click Here</a> for Webinar Listing Page</h2> 
</div>
