...
$sql = "UPDATE chapter_quiz_master SET chapter_id='$chapter_id', question='$question', optionA='$optionA', optionB='$optionB', optionC='$optionC', optionD='$optionD', option_right='$option_right', updated_date='$created_date', update_user='$username' where id='$id'";
...
.button {
  ...
  <div class="content-wrapper">
	...
	<br /><br />
<div align="center">
<h2 align="center">Your Record is Updated. <a href="chapter_quizlist.php?i=<?php echo $chapter_id; ?>">Click Here</a> for Chapter Quiz Listing Page</h2> 
</div>
