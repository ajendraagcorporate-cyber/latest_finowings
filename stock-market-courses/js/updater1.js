...
const cutprice1 = document.querySelectorAll(".cutprice1");
const banner1 = document.querySelectorAll(".banner1");
...
const getDocData = async () => {
  const { data, error } = await supabase
    ...
    .eq("course", "Technical-analysis-course-live");
  if (data) {
