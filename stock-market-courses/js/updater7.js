...
const price7 = document.querySelectorAll(".price7");
const cutprice7 = document.querySelectorAll(".cutprice7");
const banner7 = document.querySelectorAll(".banner7");
...
const getDocData = async () => {
  const { data, error } = await supabase
    ...
    .eq("course", "Fundamental-analysis-and-options-course");
  if (data) {
