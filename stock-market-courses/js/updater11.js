...
const price11 = document.querySelectorAll(".price11");
const cutprice11 = document.querySelectorAll(".cutprice11");
const banner11 = document.querySelectorAll(".banner11");
...
const getDocData = async () => {
  const { data, error } = await supabase
    ...
    .eq("course", "Market-mastery-trading-strategy-course");
  if (data) {
