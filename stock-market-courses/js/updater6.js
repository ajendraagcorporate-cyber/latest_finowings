...
const price6 = document.querySelectorAll(".price6");
const cutprice6 = document.querySelectorAll(".cutprice6");
const banner6 = document.querySelectorAll(".banner6");
...
const getDocData = async () => {
  const { data, error } = await supabase
    ...
    .eq("course", "Technical-analysis-and-options-trading");
  if (data) {
