...
const price9 = document.querySelectorAll(".price9");
const cutprice9 = document.querySelectorAll(".cutprice9");
const banner9 = document.querySelectorAll(".banner9");
