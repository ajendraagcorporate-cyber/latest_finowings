      ...
      <div class="col-lg-9 col-md-9 col-sm-12 col-12">
        <div class="grid-container">
          ...
          <main>
            ...
            <br />
            <div align="center">
              <a class="btn btn-primary py-3 px-3 mt-2" href="../mutual-fund-vs-shares/">
                << Previous</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary py-3 px-3 mt-2" href="../modes-of-investing-in-mutual-funds/">Next >></a>
            </div>
            <br /><br />
