    ...
    <div class="row">
      ...
      <div class="col-lg-9 col-md-9 col-sm-12 col-12">
        <div class="grid-container">
          ...
          <main>
            <h1 align="center"><?php echo $chapter_name; ?></h1>
            <br />
            ...
            <br />
            <div align="center">
              <a class="btn btn-primary py-3 px-3 mt-2" href="../types-of-mutual-fund">
                << Previous</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary py-3 px-3 mt-2" href="../choose-best-mutual-funds/">Next >></a>
            </div>
            <p>&nbsp;</p>
            <p><iframe class="youtube-video" title="YouTube video player" src="https://www.youtube.com/embed/XoCUm3MJUpY?si=cpk4VoFF3OOmUqA6" width="100%" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="allowfullscreen"></iframe></p>
