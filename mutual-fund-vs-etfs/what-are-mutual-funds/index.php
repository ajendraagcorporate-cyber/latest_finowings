    ...
    <div class="row">
      ...
      <div class="col-lg-9 col-md-9 col-sm-12 col-12">
        <div class="grid-container">
          ...
          <main>
            <h1 align="center"><?php echo $chapter_name; ?></h2>
              <br />
              ...
              <br />
              <div align="center">
                <a class="btn btn-primary py-3 px-3 mt-2" href="../all-about-mutual-fund">
                  << Previous</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary py-3 px-3 mt-2" href="../types-of-mutual-fund/">Next >></a>
              </div>
