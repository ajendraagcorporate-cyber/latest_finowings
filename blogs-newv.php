...
<body>
  ...
  <!-- Navbar Start -->
	...
	<?php
	while ($row = mysqli_fetch_array($trendingblogs)) 
	{
	$id = 	$row['id'];
	$title = $row['title'];
	$count = strlen("$title");
 ...
 ?>		
			   ...
			   <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="<?php echo $k; ?>s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/blogs.jpg" alt="">
                        </div>
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0"><?php echo $short_title; ?></h5>
                            <small><?php echo $short_desc1; ?></small>
                        </div>
                    </div>
                </div>
   <?php
