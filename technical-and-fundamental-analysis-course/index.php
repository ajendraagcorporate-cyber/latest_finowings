...
<div style="padding-top:20px; padding-bottom:20px;"> <a class="btn btn-primary py-3 px-5 mt-2 mb-2" href="#" target="_blank">Join Now</a></div>
...
<div align="center"><a class="btn btn-primary py-3 px-5" href="#" target="_blank">Enroll Now</a></div>
