...
<head>
  ...
  <style>
    ...
    .credit-hero-feature i { color: #4ade80; font-size: 20px; }
    ...
    .credit-hero-cta {
      ...
      box-shadow: 0 10px 30px rgba(207,156,10,0.35);
    }
    ...
    .cc-table td { padding: 35px 20px; border-bottom: 1px solid #f0f0f0; vertical-align: middle; }
...
<body>
  ...
  <section class="credit-hero-section" id="home">
    <div class="container-fw">
      <div class="credit-hero-content">
        <div class="credit-hero-text wow fadeInLeft" data-wow-delay="0.1s">
          <span class="credit-hero-badge">Curated Best Cards 2026</span>
          <h1 class="credit-hero-title">Unlock Premium <br><span>Credit Benefits</span></h1>
          <p class="credit-hero-subtitle">
            Get instant approval on high-reward credit cards. Compare the best options for online shopping, luxury travel, and daily rewards from 15+ top banks.
          </p>
          <div class="credit-hero-features">
            <div class="credit-hero-feature"><i class="fas fa-check-circle"></i> Instant 60s Approval</div>
            <div class="credit-hero-feature"><i class="fas fa-check-circle"></i> Cashback up to 5%</div>
            <div class="credit-hero-feature"><i class="fas fa-check-circle"></i> Zero Joining Fee</div>
          </div>
          <div class="d-flex flex-wrap gap-3 justify-content-center justify-content-lg-start">
            <a href="#featured" class="credit-hero-cta">View Best Offers <i class="fas fa-arrow-right ms-2"></i></a>
            <a href="#browse-banks" class="btn btn-outline-light px-5 py-3" style="border-radius:50px; font-weight:700; border-width:2px;">Compare Banks</a>
          </div>
        </div>
        ...
        <div class="credit-hero-cards wow fadeInRight" data-wow-delay="0.3s">
          <div class="credit-cards-stack">
            <div class="floating-card" style="--rotation: -12deg;">
              <img src="img/hdfc-bank-credit-card.webp" alt="HDFC">
            </div>
            <div class="floating-card" style="--rotation: 15deg;">
              <img src="img/sbi-bank-credit-card.jpg" alt="SBI">
            </div>
            <div class="floating-card" style="--rotation: -8deg;">
              <img src="img/axis-bank-credit-card.jpg" alt="Axis">
            </div>
            <div class="floating-card" style="--rotation: 10deg;">
              <img src="img/idfc-first-bank-credit-card.jpg" alt="IDFC">
            </div>
            <div class="floating-card" style="--rotation: -5deg;">
              <img src="img/indusind-bank-credit-card.jpg" alt="IndusInd">
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="featured-section" id="featured">
    <div class="container-fw">
      <div class="text-center wow fadeInUp">
        ...
        <h2 class="playfair" style="font-size: 2.8rem; color: var(--navy);">Best Credit Cards for 2026</h2>
        <p class="text-muted">Handpicked by our experts after analyzing 50+ cards based on reward caps and spending patterns.</p>
      </div>
            ...
            <tr>
              <td>
                <div class="table-card-info">
                  ...
                  <div><strong>IDFC Select</strong><br><small class="text-muted">Travel & Rewards</small></div>
                </div>
              </td>
