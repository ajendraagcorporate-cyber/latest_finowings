...
<!--Middle col start-->
<main>
<p style="font-size:12px; padding-left: 20px;"><a href="/">Home</a> >> <a href="blogs.php">Blog</a> >> <?php echo $title; ?></p>

<h2 style="color: #406ab2; padding-left: 20px;"><?php echo $title; ?></h2>
...
<p style="font-size:12px; padding-left: 25px;"><button type="button" class="btn btn-light"><?php echo $cat_name; ?></button>&nbsp;&nbsp;<button type="button" class="btn btn-light"><?php echo $day ?>.<?php echo $month ?>.<?php echo $year ?></button>&nbsp;&nbsp;<button type="button" class="btn btn-light"><img src="img/views-icon.webp" style="width:20px; height:20px;" />&nbsp;<span style="font-size:14px;"><?php echo $total_views; ?></span></button></p>
<br />
<div style="font-size:14px; padding-left: 20px;">
<div align="center"><img src="admin/media/<?php echo $img; ?>" class="img-fluid mx-auto d-block"></div>
...
<div class="wow fadeInUp" data-wow-delay="0.1s" style="background: #e9f9ff; margin: 20px;">
<br />
...
?>
<div class="row">
<div class="col-lg-4 col-md-5 col-sm-4 col-4"><img src="admin/media/<?php echo $icon; ?>" class="img-fluid"></div>
...
<div class="container-xxl py-5">
        <div class="container">
			<div class="text-center">
				<h6 class="section-title bg-white text-center text-primary px-3"><?php echo $cat_name; ?></h6>
