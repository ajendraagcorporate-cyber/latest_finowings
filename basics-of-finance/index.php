...
?>
    <div align="right">
        <strong>
            <span style="color:#273158; font-size:18px;">Welcome</span>
            <span style="color:#cf9c0a; font-size:18px;"> <?php echo $_SESSION['userinfo']['name']; ?></span> | 
            <span style="color:#273158; font-size:18px;">
          ...
          <div id="fw-unique-mobile-grid" class="fw-grid">
            ...
            ?>
              <div class="fw-card wow fadeInUp" data-wow-delay="<?php echo $i; ?>s">
                ...
                <div class="fw-content" style="width:100%; cursor:pointer;" onclick="location.href='../basics-of-finance/<?php echo $blog_url; ?>';'">
                  <a href="../../basics-of-finance/<?php echo $blog_url; ?>" class="fw-btn" aria-label="<?php echo $name; ?>">
                    Explore Now
                  </a>
                </div>
              </div>
