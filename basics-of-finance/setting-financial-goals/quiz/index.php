 ...
 <div id="page-wrap">
	...
	<form action="grade.php" method="post" id="quiz">
			...
			?>
			  ...
			  <!--<li>
                    <div class="quiz-overlay"></div>
                    <h3>2. What's your preferred method of travel?</h3>
                    <div class="mtm">
                ...
                <li>
                    <div class="quiz-overlay"></div>
                    <h3>3. What's your favorite piece of clothing that you wear?</h3>
                    <div class="mtm">
                ...
                <li>
                    <div class="quiz-overlay"></div>
                    <h3>4. Out of these, what is your favorite type of music?</h3>
                    <div class="mtm">
