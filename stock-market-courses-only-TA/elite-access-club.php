                ...
                <div class="course-box " style="background:#0A6E33;">
                    <div class="couse-img" >
                     ...
                     <div class="couse-contnt">
                        ...
                        <h2 style="color:#FFFFFF;">Exclusive Playlist only for Premium Members</h2>
                        ...
                        <p class="price">
                          ...
                          <span class="new" style="color:#FFFFFF;">₹799</span>
                         
                        </p>
                       
                      
                         <button class="custom-btn" style="background-color:#000000; font-weight:bold; border:0; font-size:16px;"><a href="https://com.rpy.club/pdp/1FW2iQfdw" style="color:#FFFFFF; text-decoration:none;">Enroll Now</a></button>
                    </div>
                    ...
                    <h2>
					 ...
					 <div class="row">
					 <p style="color:#000000;">Every Sunday 1 video with -</p>
                    <div class="col-md-3">
        ...
        <div class="container">
          ...
          <div class="row justify-content-center">
            <div class="col-md-10" style="color:#000000;">
               <p>All those people can join this membership service who do not have much time to watch the market the whole day. But interested in learning stock market and trading in the Stock Market. It will help you to provide updates of the daily Market.</p>
          </div>
...
<section class="feachures">
    <div class="container">
        ...
        <div class="row">
         <div class="col-md-12">
		 <ul>
		    <li>You will join the membership by your Mobile No/Email ID.</li>
			<li>You can purchase it at any time.</li>
			<li>The videos are only for learning purposes.</li>
			<li>No Refund Policy.</li>
			<li>For any queries you can contact us on <a href="mailto:support@finowings.com">support@finowings.com</a></li>
