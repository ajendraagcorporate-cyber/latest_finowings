        ...
        <div class="row">
                ...
                <div class="course-box" style="background:#F1CD84;">
                     ...
                     <div class="couse-contnt main">
                       ...
                       <p style="color:#06402B; font-size:14px; font-weight:bold;">Use Coupon "SPECIALCC" & GET at</p>
                        ...
                        <p>3 months Mentorship</p>
                             ...
                             <button class="custom-btn" style="background-color:#000000; font-weight:bold; border:0; font-size:16px;"><a href="https://com.rpy.club/cp/KlxbqzawMM" style="color:#FFFFFF; text-decoration:none;">Enroll Now</a></button>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <h6>Understand Market Terminology.</h6>
                        </div>
                    </div>
					   ...
					   <div class="col-md-3">
                        ...
                        <h6>Corporate Actions Insight.</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box">
				...
				<div class="row">
				 <div class="col-md-3">
					 ...
					 <div class="col-md-3">
                        ...
                        <h6>Proven & Profitable Strategies.</h6>
                        </div>
                    </div>
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <h6>1. Introduction - Technical Analysis</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>2. Detailed Technical Analysis</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>3. Strategy 1 - Swing and Positional</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>4. Strategy 2 - Nifty, Bank Nifty Special Strategy</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <h6>5. Strategy 3 - Early Bird Intraday</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>6. Strategy 4 – Climax</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>7. Strategy 5 - Intraday Trading Secret</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>8. Strategy 6 - Open High Low</h6>
                        </div>
                    </div>
