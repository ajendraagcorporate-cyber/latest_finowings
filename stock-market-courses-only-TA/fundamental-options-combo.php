                    ...
                    <div class="couse-img" >
                     ...
                     <div class="couse-contnt main">
                        ...
                        <p class="price">
                          ...
                          <span class="new">₹10999</span>
                          <span class="old">₹13000</span>
                        </p>
                      <p>3 months Mentorship</p>
                        <button class="custom-btn" style="background-color:#000000; font-weight:bold; border:0; font-size:16px;"><a href="https://com.rpy.club/pdp/RUpMaJkQv" style="color:#FFFFFF; text-decoration:none;">Enroll Now</a></button>
                    </div>
				...
				<div class="row">
				 <div class="col-md-3">
					  ...
					  <div class="col-md-3">
                        ...
                        <h6>Option Trading with Technical Analysis</h6>
                        </div>
                    </div>
