        ...
        <div class="row">
                ...
                <div class="course-box " style="background:#E4F0A1;">
                    ...
                    <div class="couse-img" >
                     ...
                     <div class="couse-contnt">
                      ...
                      <p style="color:#06402B; font-size:14px; font-weight:bold;">Use Coupon "SPECIALCT" & GET at</p>
                        ...
                        <button class="custom-btn" style="background-color:#000000; font-weight:bold; border:0; font-size:16px;"><a href="https://com.rpy.club/cp/AgEwjDlt3F" style="color:#FFFFFF; text-decoration:none;">Enroll Now</a></button>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <h6>Evening and late-night strategies for working ones.</h6>
                        </div>
                    </div>
					   ...
					   <div class="col-md-3">
                        ...
                        <h6>Real-time examples for easy implementation.</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box">
                        ...
                        <h6>Suitable for short-term and long-term traders.</h6>
                        </div>
                    </div>
				...
				<div class="row">
				 <div class="col-md-3">
                        ...
                        <h6>Focus on Indian markets like gold, silver, and crude oil.</h6>
                        </div>
                    </div>
					  ...
					  <div class="col-md-3">
                        ...
                        <h6>Step-by-step modules for all experience levels.</h6>
                        </div>
                    </div>
					 ...
					 <div class="col-md-3">
                        ...
                        <h6>Proper learning of risk management techniques.</h6>
                        </div>
                    </div>
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <h6>1. All About Commodity Trading</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>2. Crude Oil & Natural Gas Strategies</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>3. Gold and Silver Strategies</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>4. Trading Psychology</h6>
                        </div>
                    </div>
                </div>
            </div>
