...
<section class="course" id="courses" style="padding:0px !important;">
    <div class="container">
        <div class="row course-bottom">
		 ...
		 <input type="hidden" name="tid" id="tid" readonly />&nbsp;&nbsp;<input type="hidden" name="merchant_id" value="272337" />&nbsp;&nbsp;<input type="hidden" name="order_id" value="<?php echo mt_rand(10000000, 99999999) ?>"/>&nbsp;&nbsp;<input type="hidden" name="amount" value="9999" />&nbsp;&nbsp;<input type="hidden" name="currency" value="INR"/>&nbsp;&nbsp;<input type="hidden" name="redirect_url" value="https://www.mukulagrawal.com/courses1/ccavResponseHandler.php"/>&nbsp;&nbsp;<input type="hidden" name="cancel_url" value="https://www.mukulagrawal.com/courses1/ccavResponseHandler.php"/>&nbsp;&nbsp;<input type="hidden" name="language" value="EN"/>
		 
		 
                     <div class="couse-contnt">
                        <span class="recorded-btn">Recorded</span>

                        <h2 style="color:#FFFFFF;">Complete Fundamental Analysis</h2>
                        ...
                        <button class="custom-btn" style="background-color:#000000; font-weight:bold; border:0; font-size:16px;"><a href="https://com.rpy.club/cp/imhFdhTL8d" style="color:#FFFFFF; text-decoration:none;">Enroll Now</a></button>
                    </div>
				...
				<div class="row">
				 <div class="col-md-3">
                        ...
                        <h6>No need to watch the market all day.</h6>
                        </div>
                    </div>
