...
<section class="course" id="courses" style="padding:0px !important;">
        ...
        <div class="row course-bottom">
				...
				<div align="right" style="padding:10px;"><span class="recorded-btn2" style="background:red;">Date : 6th May 9:00 PM</span></div>
                     ...
                     <div class="couse-contnt">
					  ...
					  <p style="color:#000000; font-size:14px;">✅ Profitable Stock Intraday Strategy</br />
                        ...
                        <p class="price">
                          ...
                          <button class="custom-btn" style="background-color:#000000; font-weight:bold; border:0; font-size:16px;"><a href="https://com.rpy.club/wp/FdfpB6msaQ" style="color:#FFFFFF; text-decoration:none;">Enroll Now</a></button>
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <h6>Session by Mukul Agrawal (20+ Yrs Experience)</h6>
                        </div>
                    </div>
					   ...
					   <div class="col-md-3">
                        ...
                        <h6>Free WhatsApp Premium Group Access</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box">
                        ...
                        <h6>First 100 Registrations gets Special Gift!</h6>
                        </div>
                    </div>
   ...
   <section class="transform" style="padding: 50px 0px 50px; background:#E5F3FF;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                   <div class="headding">
...
Are you ready to unlock the secrets of consistent profits in both the stock and crypto markets?<br /><br />
Join us on 6th May for a power-packed live masterclass, designed to give you practical trading insights that actually work in the real market — no fluff, no theory overload.<br /><br />

This isn’t just another webinar. This is a trading breakthrough moment — where you’ll learn directly from Mukul Sir, a mentor with over 20 years of hands-on trading experience and a track record of mentoring over 10,000+ traders.<br /><br />

Whether you're struggling with intraday consistency, or confused about trading crypto in this volatile phase — this session is your roadmap to clarity and confidence.<br /><br />

All this, at just ₹99 — because we believe in real value, not fancy pricing.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container pt-5 mb-5">
          ...
          <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        <div class="diff-box1" style="background:#C6FFEE;">
        
                        <h6>Profitable Stock Intraday Strategy</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1" style="background:#C6FFEE;">
                  
                        <h6>Crypto Trading in Volatile Market</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1" style="background:#C6FFEE;">
                       
                        <h6>Live Chart Setups + Q&A</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1" style="background:#C6FFEE;">
                       
                        <h6>Psychology & Money Management</h6>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-12">
<p style="font-size:18px;">					
✅ Beginner to intermediate traders looking to level up<br /><br />

✅ Anyone trading intraday or looking to start safely<br /><br />

✅ Crypto enthusiasts seeking structured, risk-managed setups<br /><br />

✅ Traders tired of YouTube noise & shortcut tips — and want real, reliable frameworks
                        </div>
                    </div>
                </div>
            </div>
...
<section class="feachures">
    <div class="container">
        ...
        <div class="row">
         <div class="col-md-12">
		 <ul>
		    <li>The Live Session will be start on 6th May, 9:00 PM.</li>
