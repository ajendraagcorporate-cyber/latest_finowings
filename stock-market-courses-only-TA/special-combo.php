...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section class="banner">
        <div class="container">
		 <div class="header-logo"><a href="https://www.finowings.com/"><img src="assets/images/banner/ma-logo1.png" ></a></div>
            
        </div>
    </section>
    

<section class="course" id="courses" style="padding:0px !important;">
    <div class="container">
        <div class="row">
			            <div class="col-md-4">
                <div class="course-box " style="background:#e4fff7;">
                    <div class="couse-img" >
                     ...
                     <div class="couse-contnt main">
                        ...
                        <p class="price">
                          ...
                          <span class="new">₹24999</span>
                          <span class="old">₹29000</span>
                        </p>
                      <p>3 months Mentorship</p>
                        <button class="custom-btn" style="background-color:#000000; font-weight:bold; border:0; font-size:16px;"><a href="https://com.rpy.club/pdp/ysaEdyYz1" style="color:#FFFFFF; text-decoration:none;">Enroll Now</a></button>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <h6>Learn the Basic to Advance Technical Analysis of the Stock Market</h6>
                        </div>
                    </div>
					   ...
					   <div class="col-md-3">
                        ...
                        <h6>Master the Rule of 2% Trading</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box">
                        ...
                        <h6>Learn to trade with a proper risk & reward Ratio</h6>
                        </div>
                    </div>
				...
				<div class="row">
				 <div class="col-md-3">
                        ...
                        <h6>No need to watch the market full day</h6>
                        </div>
                    </div>
					  ...
					  <div class="col-md-3">
                        ...
                        <h6>Simple trade without any indicator and software</h6>
                        </div>
                    </div>
					 ...
					 <div class="col-md-3">
                        ...
                        <h6>Learn Basics to Advance Techniques of fundamental</h6>
                        </div>
                    </div>
				...
				<div class="row">
				 <div class="col-md-3">
                        ...
                        <h6>Identifying undervalued stocks at an early stage</h6>
                        </div>
                    </div>
					  ...
					  <div class="col-md-3">
                        ...
                        <h6>Learn to invest with proper stock selection process</h6>
                        </div>
                    </div>
					 ...
					 <div class="col-md-3">
                        ...
                        <h6>Learn to build a diversified portfolio</h6>
                        </div>
                    </div>
				...
				<div class="row">
				 <div class="col-md-3">
                        ...
                        <h6>Options Terminology and Pricing Models</h6>
                        </div>
                    </div>
					...
					<div class="col-md-3">
                        ...
                        <h6>Volatility Trading with India VIX</h6>
                        </div>
                    </div>
    ...
    <section class="combo">
        <div class="container">
            ...
            <div class="col-md-10">
			<h5 align="center">Fundamental Analysis Concepts</h5><br />
                <div class="row">
                    <div class="col-md-3">
                        <div class="diff-box1">
        
                        <h6>1. Why’s and What’s of Fundamental Analysis</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>2. ABC’s of Fundamental Analysis</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>3. Key websites to know before the journey</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>4. Annual Reports</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <h6>5. Introduction to Financial Statements</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>6. Ratio Analysis</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>7. How to identify the right company</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>8. Finding right Valuation</h6>
                        </div>
                    </div>
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <h6>9. Banking & Insurance Analysis</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>10. Portfolio Management</h6>
                        </div>
                    </div>
          ...
          <div class="row justify-content-center pt-5">
            <div class="col-md-10">
			<h5 align="center">Technical Analysis Concepts</h5><br />
                <div class="row">
                    <div class="col-md-3">
                        <div class="diff-box1">
        
                        <h6>1. Candlestick Secrets</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>2. Trendline Mastery</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>3. Demand & Supply Zones</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>4. Price Action Strategies</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <h6>5. Proven Intraday Tactics</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>6. BTST & STBT Edge</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>7. Risk Management</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <h6>9. Gap Trading Mastery</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>10. Fibonacci Power</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>11. Advanced Fibonacci Analysis</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>12. Divergence with Confirmation</h6>
                        </div>
                    </div>
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <h6>13. Wolfe Wave Technique</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>14. Stock Selection Process</h6>
                        </div>
                    </div>
					...
					<div class="col-md-3">
		  			 ...
		  			 <div class="row justify-content-center pt-5">
            <div class="col-md-10">
			<h5 align="center">Options Trading Concepts</h5><br />
                <div class="row">
                    <div class="col-md-3">
                        <div class="diff-box1">
        
                        <h6>1. Options Strategies</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>2. Volatility Trading with India VIX</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>3. Option Trading with Technical Analysis</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                       
                        <h6>4. Options Chain Analysis</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <h6>5. PCR & Max Pain Strategies</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>6. Comprehensive Coverage</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                    ...
                    <div class="col-md-3">
                        ...
                        <h6>8. Volatility Trading Mastery</h6>
                        </div>
                    </div>
            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <h6>9. Strategic Insights</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="diff-box1">
                  
                        <h6>10. Trading Tools</h6>
                        </div>
                    </div>
					 ...
					 <div class="col-md-3">
                        ...
                        <h6>11. Best Intraday Strategies</h6>
                        </div>
                    </div>
...
<section class="feachures">
    <div class="container">
        ...
        <div class="row">
         <div class="col-md-12">
		 <ul>
		    <li>All the recorded lectures will be valid for 90 days with unlimited views from date of purchase.</li>
			<li>If you wish to watch the lecture after the expiry of the product you will have to repurchase the same.</li>
			<li>It is a single-device product ie. It will Login on One Device at a Time. It can be Mobile or PC.</li>
			<li>If you play Recorded Videos on PC then it will be access only on Google Chrome or Safari.</li>
			<li>For more information please drop an email to <a href="mailto:support@finowings.com">support@finowings.com</a></li>
			<li>Course fees are non-refundable</li>
		 </ul>
        </div>
    </div>
</section>
