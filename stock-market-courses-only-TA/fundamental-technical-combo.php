...
<section class="course" id="courses" style="padding:0px !important;">
    <div class="container">
        <div class="row">
			            <div class="col-md-4">
                <div class="course-box " style="background:#E5F3FF;">
                    <div class="couse-img" >
                     ...
                     <div class="couse-contnt main">
                        ...
                        <p class="price">
                          ...
                          <span class="new">₹18999</span>
                          <span class="old">₹23000</span>
                        </p>
                      <p>3 months Mentorship</p>
                        <button class="custom-btn" style="background-color:#000000; font-weight:bold; border:0; font-size:16px;"><a href="https://com.rpy.club/pdp/QarvtyT4G" style="color:#FFFFFF; text-decoration:none;">Enroll Now</a></button>
                    </div>
				...
				<div class="row">
				 <div class="col-md-3">
					  ...
					  <div class="col-md-3">
                        ...
                        <h6>Earn in 1 hr. & go your work.</h6>
                        </div>
                    </div>
