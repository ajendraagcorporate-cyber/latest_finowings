...
<section class="course" id="courses" style="padding:0px !important;">
    <div class="container">
        <div class="row">
		 ...
		 <input type="hidden" name="tid" id="tid" readonly />&nbsp;&nbsp;<input type="hidden" name="merchant_id" value="272337" />&nbsp;&nbsp;<input type="hidden" name="order_id" value="<?php echo mt_rand(10000000, 99999999) ?>"/>&nbsp;&nbsp;<input type="hidden" name="amount" value="22999" />&nbsp;&nbsp;<input type="hidden" name="currency" value="INR"/>&nbsp;&nbsp;<input type="hidden" name="redirect_url" value="https://www.mukulagrawal.com/courses1/ccavResponseHandler.php"/>&nbsp;&nbsp;<input type="hidden" name="cancel_url" value="https://www.mukulagrawal.com/courses1/ccavResponseHandler.php"/>&nbsp;&nbsp;<input type="hidden" name="language" value="EN"/>
					
                     <div class="couse-contnt main">
                        <span class="recorded-btn">Live + Recorded</span>

                        <h2>Unlock the power of technical analysis trading 
                           
                           
                        </h2>
                      <p style="color:#06402B; font-size:14px; font-weight:bold;">Use Coupon "SPECIALTA" & GET at</p>
                        <p class="price">
                         
                          <span class="new">₹17999</span>
                          <span class="old">₹22,999</span>
                        </p>
                        <p>3 months Mentorship</p>
                      
                        <button class="custom-btn" style="background-color:#000000; font-weight:bold; border:0; font-size:16px;"><a href="https://com.rpy.club/wp/HZ8GVkha0l" style="color:#FFFFFF; text-decoration:none;">Enroll Now</a></button>
                    </div>
