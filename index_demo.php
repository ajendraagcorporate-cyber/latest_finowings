...
<head>
  ...
  Fonts links end For Automatic Popup -->
    ...
    <!-- Code with Ajendra: Offer Strip CSS Start (Currently Commented in Body) -->

    <!-- Code with Ajendra: Offer Strip CSS End -->
...
<body>
    ...
    <div id="demo" class="carousel slide" data-ride="carousel" data-interval="3000" style="z-index:20;">
      ...
      <a href="https://courses.finowings.com/mukul-agrawal-courses/enroll/179/0/live">
        <img loading="lazy" src="img/banner_26_jan_main.webp" alt="Stock Market Courses" class="img-fluid mx-auto d-block">
      </a>
    </div>
  ...
  <div class="carousel-item">
      <a href="https://courses.finowings.com/stock-market-courses-recorded">
        <img loading="lazy" src="img/recorder-img-web-banner.webp" alt="Stock Market Courses" class="img-fluid mx-auto d-block">
      </a>
    </div>
    ...
    <section id="fw-trading-upgrade">
        <div class="fw-container">
            ...
            <div class="fw-image-wrapper wow fadeInLeft" data-wow-delay="0.1s">
                <img src="img/stock-market-learnings.webp" alt="Stock Trading Class" class="fw-main-img" style="border: 5px solid #fff !important;">
            </div>
            ...
            <div class="fw-content wow fadeInRight" data-wow-delay="0.2s">
                ...
                <div class="fw-cta-area">
                    ...
                    <div class="fw-ceo-profile">
                        <img src="img/avatar-secret-Club.webp" alt="Mukul" class="fw-ceo-img">
            ...
            <div class="fw-grid">
                ...
                <div class="fw-card wow fadeInUp" data-wow-delay="0.1s">
                    <div class="fw-img-box">
                        <img src="https://courses.finowings.com/images/courses/thumbnails/696799032643e.jpeg" loading="lazy" alt="Course 1">
                    </div>
                ...
                <div class="fw-card wow fadeInUp" data-wow-delay="0.2s">
                    <div class="fw-img-box">
                        <img src="https://courses.finowings.com/images/courses/thumbnails/696798a02177a.jpeg" loading="lazy" alt="Course 2">
                    </div>
                    <div class="fw-content">
                        <div class="fw-meta">
                ...
                <div class="fw-card wow fadeInUp" data-wow-delay="0.3s">
                    <div class="fw-img-box">
                        <img src="https://courses.finowings.com/images/courses/thumbnails/696798823f309.jpeg" loading="lazy" alt="Course 3">
                    </div>
                    <div class="fw-content">
                        <div class="fw-meta">
                ...
                <div class="fw-card wow fadeInUp" data-wow-delay="0.4s">
                    <div class="fw-img-box">
                        <img src="https://courses.finowings.com/images/courses/thumbnails/696798584c759.jpeg" loading="lazy" alt="Course 4">
                    </div>
                    <div class="fw-content">
                        <div class="fw-meta">
                ...
                <div class="fw-card wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fw-img-box">
                        <img src="https://courses.finowings.com/images/courses/thumbnails/6967993ba44e9.jpeg" loading="lazy" alt="Course 5">
                    </div>
                    <div class="fw-content">
                        <div class="fw-meta">
                ...
                <div class="fw-card wow fadeInUp" data-wow-delay="0.6s">
                    <div class="fw-img-box">
                        <img src="https://courses.finowings.com/images/live/thumbnails/69679518c913f.jpeg" loading="lazy" alt="live-class">
                    </div>
                    <div class="fw-content">
                        <div class="fw-meta">
                        ...
                        <h5 class="fw-title">25th January Technical Analysis (Live+Rec) 2026</h5>
...
Learn smart, risk-managed strategies with Dr. Mukul Agrawal.</p>
                        ...
                        <a href="https://courses.finowings.com/mukul-agrawal-courses/enroll/179/0/live" target="_blank" class="fw-btn">Enroll Now</a>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-md-12 text-center">
                        <div class="em-app-image" id="mobile-animate">
                            <img src="img/home-page-app.webp" alt="MukulAgrawal App" class="img-fluid" loading="lazy">
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-5 wow fadeInUp" data-wow-delay="0.1s">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h2 class="mb-2">Master the Stock Market with Finowings Academys</h2>
            ...
            <div id="fw-unique-mobile-grid" class="fw-grid">
                ...
                ?>
                    <div class="fw-card wow fadeInUp" data-wow-delay="<?php echo $i; ?>s">
                        <div class="fw-img-box">
                            <a href="<?php echo $url; ?>/">
                                <img loading="lazy" class="img-fluid" src="admin/media/courseicons/<?php echo $icon; ?>" alt="<?php echo $topic; ?>">
                            </a>
                        </div>
                                ...
                                <div class="pop-up-box">
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12 col-12 mb-3">
                                            <a href="https://www.finowings.com/learn-intraday-strategy/" target="_blank"><img loading="lazy" src="img/diwali-offers.webp" class="img-fluid"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
