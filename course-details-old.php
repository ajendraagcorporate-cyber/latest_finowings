   ...
   <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Open Demat Account<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
    <!-- Navbar Ends -->
...
<h2 style="color: #406ab2;"><?php echo $title; ?></h2>
...
<font style="padding-top:20px; font-size:16px;">Instructor: <span style="color: #406ab2;">Mukul Agrawal</span></font><br>
<font style="padding-top:20px; font-size:16px;">Language: <span style="color: #406ab2;"><?php echo $languages; ?></span></font><br><br>
<font style="padding-top:20px; font-size:24px; color: #406ab2;">&#x20B9; <?php echo $sale_p; ?></font>&nbsp;&nbsp;<font style="padding-top:20px; font-size:18px; color: red;"><del>&#x20B9; <?php echo $price; ?></del></font><br /><font style="font-size: 14px;">&nbsp;including 18% GST</font>
...
<div style="padding-top:20px;"> <a class="btn btn-primary py-3 px-5 mt-2 mb-2" href="<?php echo $classplus_link; ?>" target="_blank">Join Now</a></div>

</div>

<div class="col-lg-3 col-md-3 col-sm-6 col-12 pt-2" style="background:#e9f9ff;">
<h2 align="center" style="color: #406ab2;">Upcoming Batch</h2>
<div align="center" style="font-size:24px; font-weight:600; background: #00abe9; color:#FFFFFF;"><p id="demo"></p></div>

<h5 style="padding-top:20px; padding-left:10px;">Special Offers</h5>
...
<div align="center"><a class="btn btn-primary py-3 px-5 mt-2 mb-2" href="<?php echo $classplus_link; ?>" target="_blank">Enroll Now</a></div>
