...
<head>
    <meta charset="utf-8">
    <title>Upcoming SME IPOs 2025 | Price, Listing Date, GMP and Status</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Best IPO Blogs" name="keywords">
    <meta content="Upcoming SME IPOs in 2025: Get updates on IPOs, including dates, valuations, and GMPs. Make informed choices for a successful financial portfolio." name="description">
...
<p style="font-size:14px;"><a href="http://www.finowings.com/SME-IPO/" style="text-decoration: none; color: #406ab2;"><?php echo $cat_name; ?></a> | <?php echo $day; ?>-<?php echo $month; ?>- <?php echo $year; ?></p>
<?php
if ($count < 31)
{
?>
...
<!--<a href="blog-topic.php?i=<?php //echo $id; ?>" class="btn btn-info btn-block" style="font-size:16px;">Continue Reading</a>-->
 <a class="btn btn-primary py-3 px-5 mt-2" href="https://www.finowings.com/IPO/<?php echo $blog_url; ?>">Continue Reading</a>
</div>
</div>
<?php
 }
