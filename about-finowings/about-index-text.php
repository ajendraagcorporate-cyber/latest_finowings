...
<style>
  ...
  .fw-course-card .num:hover { color: var(--gold); }
...
<section class="fw-hero">
  ...
  <div class="fw-hero-btns fade-up delay-3">
    <a href="https://courses.finowings.com/stock-market-courses" class="fw-btn-primary"><i class="fas fa-play-circle"></i> Explore Courses</a>
    <a href="#Offer" class="fw-btn-outline">Learn More</a>
  </div>
</section>
  ...
  <div class="fw-section-inner">
    <div class="fw-about-grid">
      <div class="fw-about-img-wrap reveal">
        <img src="../admin/media/ezgif.com-gif-maker (1).webp" alt="Finowings Academy Trading Education" loading="lazy">
...
<!-- ══════════ WHAT WE DO ══════════ -->
<section class="fw-dark-section" id="Offer">
  <div class="fw-section-inner">
    <div style="text-align:center;" class="reveal">
...
<section class="fw-cta-section">
  <div class="fw-section-inner">
    ...
    <div class="fw-cta-btns reveal">
      <a href="https://courses.finowings.com/stock-market-courses" class="fw-btn-primary"><i class="fas fa-graduation-cap"></i> Join Stock Market Courses</a>
      <a href="https://www.finowings.com/finowings-academy/" class="fw-btn-outline">Explore Academy</a>
    </div>
...
<div class="container-xxl" style="background: #e9f9ff; padding: 40px; border-radius: 15px;">
        <div class="container reveal" data-wow-delay="0.3s">
          <br /><br />
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  What is Finowings Academy?
                </button>
              </h2>
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  <p>Finowings Academy is a stock market training platform that provides beginner-friendly courses on trading, investing, and financial education in India.</p>
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingTwo">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                  Is Finowings suitable for beginners?
                </button>
              </h2>
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  <p>Yes, Finowings is designed for beginners with simple explanations, step-by-step learning, and no prior financial knowledge required.</p>
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingThree">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                  What courses does Finowings offer?
                </button>
              </h2>
              <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  <p>Finowings offers stock market courses, technical analysis training, fundamental analysis, trading strategies, and financial literacy programs.</p>
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFour">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                  How is Finowings different from other platforms?
                </button>
              </h2>
              <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  <p>Finowings focuses on practical learning, real market examples, and beginner-friendly teaching instead of only theoretical concepts.</p>
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFive">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                  Do I get live support or mentorship?
                </button>
              </h2>
              <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  <p>Yes, Finowings provides live doubt sessions and mentorship support to help you understand concepts and improve learning.</p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingSix">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                  Can I learn stock market trading without any background?
                </button>
              </h2>
              <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  <p>Absolutely. Finowings courses are structured to help complete beginners learn stock market trading from scratch.</p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingSeven">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                  Does Finowings provide investment advice?
                </button>
              </h2>
              <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  <p>No, Finowings provides educational content only and does not offer investment or trading advice.</p>
                </div>
              </div>
            </div>
