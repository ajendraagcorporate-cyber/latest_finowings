      ...
      <div class="col-lg-9 col-md-9 col-sm-12 col-12">
        <div class="grid-container">
          <main>
            ...
            <br />
            <div align="center">
              <a class="btn btn-primary py-3 px-3 mt-2" href="../investing-in-commercial-real-estate/">
                << Previous</a>&nbsp;&nbsp;&nbsp;&nbsp; <a class="btn btn-primary py-3 px-3 mt-2" href="../investing-in-special-real-estate">Next >></a>
            </div>
            <br /><br />
