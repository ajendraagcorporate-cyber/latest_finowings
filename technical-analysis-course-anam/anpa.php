...
$oder_value = $_REQUEST['order_value'];
?>
<!DOCTYPE html>
<html lang="en">
...
<h2 align="center">Techical Analysis (Live) - Terms & Condtions</h2>
		  <div class="row">
		 <input type="hidden" name="tid" id="tid" readonly />&nbsp;&nbsp;<input type="hidden" name="merchant_id" value="272337" />&nbsp;&nbsp;<input type="hidden" name="order_id" value="<?php echo mt_rand(10000000, 99999999) ?>"/>&nbsp;&nbsp;<input type="hidden" name="amount" value="<?php echo $oder_value; ?>" />&nbsp;&nbsp;<input type="hidden" name="currency" value="INR"/>&nbsp;&nbsp;<input type="hidden" name="redirect_url" value="https://www.finowings.com/technical-analysis-course/ccavResponseHandler.php"/>&nbsp;&nbsp;<input type="hidden" name="cancel_url" value="https://www.finowings.com/technical-analysis-course/ccavResponseHandler.php"/>&nbsp;&nbsp;<input type="hidden" name="language" value="EN"/>
