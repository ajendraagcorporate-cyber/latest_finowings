...
<head>
    ...
    <meta content="Technical analysis is considered better for short term investors or traders and fundamental analysis for long term investors. With the help of price and volume, you can make the right decision of entry and exit for the long term." name="description">
...
<link rel="manifest" href="/site.webmanifest">
  ...
  <style>
    /* Sabhi screen sizes par width restriction hata dega */
    .container {
        max-width: 80% !important;
        width: 100% !important;
        padding-left: 15px; /* Optional: Thoda gap rakhne ke liye */
        padding-right: 15px;
    }
</style>
</head>
    ...
    <!-- Courses Section Start -->
     <div class="container-xxl py-5">
		...
		?>
                ...
                <div class="fw-content" style="width:100%; cursor:pointer;" onclick="location.href='<?php echo $blog_url; ?>';'">
                  <a href="<?php echo $blog_url; ?>" target="_blank" class="fw-btn">
                    <?php echo $name; ?>
                  </a>
                </div>
              </div>
