      ...
      <div class="col-lg-9 col-md-9 col-sm-12 col-12">
        <div class="grid-container">
          ...
          <main>
            ...
            <br />
            <div align="center">
              <a class="btn btn-primary py-3 px-3 mt-2" href="../what-is-a-trend/">
                << Previous</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary py-3 px-3 mt-2" href="../trend-reversal-patterns/">Next Chapter >></a>
            </div>
            <!-- Quiz Section Starts -->
