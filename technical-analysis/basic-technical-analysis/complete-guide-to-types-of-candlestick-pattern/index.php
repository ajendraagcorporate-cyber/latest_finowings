      ...
      <div class="col-lg-9 col-md-9 col-sm-12 col-12">
        <div class="grid-container">
          ...
          <main>
            ...
            <br />
            <div align="center">
              <a class="btn btn-primary py-3 px-3 mt-2" href="../beginner-guide-to-technical-analysis">
                << Previous</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary py-3 px-3 mt-2" href="../what-are-technical-charts/">Next Chapter >></a>
            </div>
        ...
        <div class="right-header">
          <div class="rightsidebar">
            ...
            ?>
              ...
              ?>
                <div class="row">
                  <div class="col-lg-4 col-md-5 col-sm-4 col-4"><img src="https://www.finowings.com/admin/media/courseicons/<?php echo $img; ?>" alt="<?php echo $alt_text; ?>" class="img-fluid"></div>
                  <div class="col-lg-8 col-md-7 col-sm-8 col-8">
