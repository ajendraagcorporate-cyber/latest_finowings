...
$allchapters = getChaptersF($topic_id);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['pname'])) {
    ...
    $mobile = mysqli_real_escape_string($con, $_POST['pphone']);
    $email = mysqli_real_escape_string($con, $_POST['pemail']);
    $date = date("Y-m-d H:i:s"); // Corrected H:i:s format
...
<br />
<div align="center">
 <a class="btn btn-primary py-3 px-3 mt-2" href="../../tradingview-as-a-beginner/"><< Read Chapter</a>
</div>
<br />
...
<h4 align="left">All Chapters</h4>
<br />

<?php
while($r = mysqli_fetch_array($allchapters))
{
	$id = $r['id'];
