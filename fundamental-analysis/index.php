...
<head>
    ...
    <meta content="Fundamental Analysis: Master fundamental analysis to understand businesses and make smart, long-term investment decisions confidently." name="description">
	...
	if(!empty($_SESSION['userinfo']))
     ...
     <section id="fw-custom-section" class="courses-section">
		...
		?>	
                ...
                <div class="fw-content" style="width:100%; cursor:pointer;" onclick="location.href='../fundamental-analysis/<?php echo $blog_url; ?>';'">
                  <a href="../../fundamental-analysis/<?php echo $blog_url; ?>"  class="fw-btn" aria-label="<?php echo $name; ?>">
                    Explore Now
                  </a>
                </div>
              </div>
